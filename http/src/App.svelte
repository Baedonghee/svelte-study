<script>
	...
	isLoading = true;
	let getHobbies = fetch('https://svelte-course-acda7-default-rtdb.firebaseio.com/hobbies.json')
		.then(res => {
			if (!res.ok) {
	...
	function addHobby() {
		...
		isLoading = true;
		fetch('https://svelte-course-acda7-default-rtdb.firebaseio.com/hobbies.json', {
			method: 'POST',
